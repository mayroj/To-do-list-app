...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		// TODO: write test
        var todo = {}; // todos est vide
        setUpModel([todo]); //installation de model
        
        subject.setView(''); //definit la view
        
        // attend que la vue soit rendue avec showEntries et le tableau vide
